...
#'
#' This is the hg19 (human) version of MitoCarta 2.0, downloaded from 
...
#' http://nar.oxfordjournals.org/content/early/2015/10/07/nar.gkv1003.full
#' 
#' Please cite the publication if you use the MitoCarta database. 
#' 
#' @format A GRanges object.
#' @source \url{http://www.broadinstitute.org/ftp/distribution/metabolic/papers/Pagliarini/MitoCarta2.0/Human.MitoCarta2.0.bed}
#' 
#' @examples
